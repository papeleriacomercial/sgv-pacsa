...
Arriba, bajo el título, quedan tres renglones que escribe el generador:

| Renglón | De dónde sale |
|---|---|
| Preparado para *cliente* · *fecha* | La cuenta y el reloj |
| *Empresa* · teléfono · correo · web | La tabla `empresa`, la misma que firma la cotización |
| Su vendedor: *nombre* · *teléfono* | El perfil de quien tiene la sesión abierta |

Y el **logo va incrustado dentro del archivo**, anclado arriba a la derecha. No es un enlace: viaja
en el `.xlsx`, así que se ve aunque el cliente lo abra sin internet.
...
escribe el generador: que los renglones se armen sin separadores sueltos, que sin nombre de vendedor
no salga el rótulo, que las cuatro piezas del logo estén en el paquete, y que **ningún nombre apunte
a una hoja que no existe**.
