...
septiembre de 2026 el usuario lo mandó quitar**, y la razón es de forma y no de fondo: *«la tercera
línea quedó muy extendida»*. Era una sola frase larga en una columna de 54 caracteres, así que se
derramaba hacia la derecha y descuadraba la hoja entera al abrirla.
...
**Lo que quedó descubierto**, y hay que decirlo: **la hoja ya no declara cuándo el metraje de la
competencia es una estimación nuestra y no una medición.** El ofrecimiento de medir está; la
advertencia de que la cifra puede no ser exacta, no. Está en los riesgos de abajo como decisión
abierta.
...
**Las pruebas se validaron rompiendo el código a propósito** — el redondeo hacia arriba y la regla
de todo-o-nada— y cada ruptura hizo fallar sólo a la prueba que le tocaba. Una prueba que pasa sin
...
**Y desde el 2 de septiembre de 2026 la hoja ya no lo declara.** El renglón que decía «esta cifra es
una estimación» se retiró por su forma —ocupaba demasiado ancho—, no porque dejara de hacer falta.
**Queda pendiente decidir dónde vuelve**: la salida natural son dos líneas cortas junto al aviso del
«80 × 70», que es donde ya viven las advertencias sobre el metraje y donde sí caben en el ancho de
la columna.
...
| Fecha | Qué cambió |
|---|---|
| 2026-09-02 | **Se retira el aviso de metraje sin medir**, por ancho: *«la tercera línea quedó muy extendida»*. Con él se van `COMPARADOR_AVISO`, la marca de competencia y el interruptor de medido/estimado de la pantalla. La declaración queda pendiente de reubicar |
